...
define sssd::provider::ldap (
  ...
  Optional[Boolean]              $ldap_enumeration_refresh_timeout  = undef,
  ...
  Optional[Boolean]               $ldap_id_use_start_tls             = true,
  ...
  Optional[Boolean]               $ldap_krb5_ticket_lifetime         = undef,
  ...
  Optional[Boolean]              $ldap_chpass_dns_service_name      = undef,
