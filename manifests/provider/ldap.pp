...
define sssd::provider::ldap (
  ...
  $ldap_nds_login_disabled = '',
  $ldap_nds_login_expiration_time = '',
  $ldap_nds_login_allowed_time_map = '',
  $ldap_user_principal = '',
...
# Advanced Configuration - Read the man page
  ...
  validate_string($ldap_user_ad_account_control)
  validate_string($ldap_ns_account_lock)
  validate_string($ldap_nds_login_diabled)
  validate_string($ldap_nds_expiration_time)
  validate_string($ldap_nds_allowed_time_map)
  ...
  unless empty($ldap_search_enumeration_timeout) { validate_integer($ldap_search_enumeration_timeout) }
