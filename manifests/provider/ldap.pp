...
define sssd::provider::ldap (
  ...
  String[1]                             $ldap_search_base                  = simplib::lookup('simp_options::ldap::base_dn', { 'default_value' => undef }),
  Sssd::LdapSchema                      $ldap_schema                       = 'rfc2307',
  String[1]                             $ldap_default_bind_dn              = simplib::lookup('simp_options::ldap::bind_dn', { 'default_value' => undef }),
